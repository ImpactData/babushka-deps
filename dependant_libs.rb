dep '2.3.9.rails.nativelibs' do
    ...
    requires 'rubydev.aptget', 'libxml2dev.aptget', 'libsasl2dev.aptget' ,'libxsltdev.aptget', 'libxml2dev.aptget', 'imagemagick.aptget', 'libmagickcoredev.aptget', 'libmagickwanddev.aptget', 'libreadline_ruby.aptget', 'memcached.aptget', 'libreadline5_dev.aptget'
end
...
dep 'libreadline5_dev.aptget' do
